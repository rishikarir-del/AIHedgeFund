 ...
 *
 * Robustness testing -- parameter neighbourhoods, cost stress, regime
 * segmentation -- belongs here. Metric calculation currently runs inside
 * worker-backtest because it is part of ingestion; it moves here when
 * robustness work needs it independently.
 *
